            ...
            <MDBCard className="mb-4">
              ...
              <MDBCardBody>
                <MDBListGroup flush>
                  ...
                  <MDBListGroupItem className="justify-content-between align-items-center" style={{ minWidth: '22rem' }} light small  >

                  {products.map((item) => (<div className={""}> <span className={"item_title"}> {item.product }:</span>{item.priceForAll} $ </div>))}
                  ...
                  <MDBListGroupItem className="d-flex justify-content-between align-items-center border-0 px-0 mb-3">
                    ...
                    <span>
                      <strong> <div> <span className={"item_title"}></span>{sum} $</div></strong>
                    </span>
                  </MDBListGroupItem>
                </MDBListGroup>
          ...
          <MDBCol md="8">
            <MDBCard className="mb-4">
              ...
              <MDBCardBody>
                ...
                {/* Product  */}
                {products.map((item) => (<div className={'MDBRow'}>
                <MDBRow>
                  ...
                  <MDBCol lg="3" md="12" className="mb-4 mb-lg-0">
                    ...
                    <p>                   
                      <strong><div className={"item"}><span className={"item_title"}>Produit:</span> {item.product} </div></strong>
                    </p>
